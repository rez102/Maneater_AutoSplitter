...
現時点ではEpic版での使用を想定しています。steam版も後々対応させます。
...
Epic版ではMoviePlayerのLoading Screenフラグを使ってGame Timeを停止します。

Steam版のロード除去は未対応です。Steam版用のアドレスが分かり次第、追加予定です。

## 注意

- ASLはManeater Epic版での検証を中心に作成しています。
